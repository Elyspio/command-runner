...
export class UsersAuthorisationsApi extends BaseAPI {
    ...
    public get(username: string, authenticationToken?: string, authenticationToken2?: string, options?: AxiosRequestConfig) {
        return UsersAuthorisationsApiFp(this.configuration).get(username, authenticationToken, authenticationToken2, options).then((request) => request(this.axios, this.basePath));
    }
    ...
    public set(username: string, authorizationModel: AuthorizationModel, authenticationToken?: string, authenticationToken2?: string, options?: AxiosRequestConfig) {
        return UsersAuthorisationsApiFp(this.configuration).set(username, authorizationModel, authenticationToken, authenticationToken2, options).then((request) => request(this.axios, this.basePath));
    }
}
...
export class UsersCredentialsApi extends BaseAPI {
     ...
     */
    public get(username: string, authenticationToken?: string, authenticationToken2?: string, options?: AxiosRequestConfig) {
        return UsersCredentialsApiFp(this.configuration).get(username, authenticationToken, authenticationToken2, options).then((request) => request(this.axios, this.basePath));
    }
    ...
    public set(username: string, credentialsModel: CredentialsModel, authenticationToken?: string, authenticationToken2?: string, options?: AxiosRequestConfig) {
        return UsersCredentialsApiFp(this.configuration).set(username, credentialsModel, authenticationToken, authenticationToken2, options).then((request) => request(this.axios, this.basePath));
    }
}
...
export class UsersSettingsApi extends BaseAPI {
     ...
     */
    public get(username: string, authenticationToken?: string, authenticationToken2?: string, options?: AxiosRequestConfig) {
        return UsersSettingsApiFp(this.configuration).get(username, authenticationToken, authenticationToken2, options).then((request) => request(this.axios, this.basePath));
    }
    ...
    public getTheme(username: string, windowsTheme: 'dark' | 'light', authenticationToken?: string, authenticationToken2?: string, options?: AxiosRequestConfig) {
        return UsersSettingsApiFp(this.configuration).getTheme(username, windowsTheme, authenticationToken, authenticationToken2, options).then((request) => request(this.axios, this.basePath));
    }
    ...
    public set(username: string, setUserSettingsModel: SetUserSettingsModel, authenticationToken?: string, authenticationToken2?: string, options?: AxiosRequestConfig) {
        return UsersSettingsApiFp(this.configuration).set(username, setUserSettingsModel, authenticationToken, authenticationToken2, options).then((request) => request(this.axios, this.basePath));
    }
}
